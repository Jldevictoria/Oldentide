...
func pullRaceTemplates() []shared.RaceTemplate {
	...
	for rows.Next() {
		...
		err = rows.Scan(
			...
			&raceTemplate.LeshicMod,
			&raceTemplate.ElvishMod,
			&raceTemplate.OrcishMod,
			&raceTemplate.CommonMod,
			&raceTemplate.DwarvishMod,
			&raceTemplate.GnomishMod,
...
func pullProfessionTemplates() []shared.ProfessionTemplate {
	...
	for rows.Next() {
		...
		err = rows.Scan(
			...
			&professionTemplate.LeshicMod,
			&professionTemplate.ElvishMod,
			&professionTemplate.OrcishMod,
			&professionTemplate.CommonMod,
			&professionTemplate.DwarvishMod,
			&professionTemplate.GnomishMod,
