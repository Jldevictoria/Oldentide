...
CREATE TABLE players (
    ...
    maxsp integer not null default 0,
    ...
    -- Language:
    leshic integer not null default 0,
    elvish integer not null default 0,
    orcish integer not null default 0,
    common integer not null default 0,
    dwarvish integer not null default 0,
    gnomish integer not null default 0,
    -- Equipment:
    head text,
    chest text,
    arms text,
...
CREATE TABLE race_templates (
    ...
    -- Language:
    leshic_mod real not null default 0.0,
    elvish_mod real not null default 0.0,
    orcish_mod real not null default 0.0,
    common_mod real not null default 0.0,
    dwarvish_mod real not null default 0.0,
    gnomish_mod real not null default 0.0,
    description text not null
);
