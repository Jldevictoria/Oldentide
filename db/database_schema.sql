...
DROP TABLE IF EXISTS development_points_per_level;
CREATE TABLE development_points_per_level (
    level_1 integer not null default 1500,
    level_2 integer not null default 1575,
    level_3 integer not null default 1729,
    level_4 integer not null default 1965,
    level_5 integer not null default 2289,
    level_6 integer not null default 2704,
    level_7 integer not null default 3214,
    level_8 integer not null default 3823,
    level_9 integer not null default 4534,
    level_10 integer not null default 5353,
    level_11 integer not null default 6283,
    level_12 integer not null default 7328,
    level_13 integer not null default 8492,
    level_14 integer not null default 9778,
    level_15 integer not null default 11192,
    level_16 integer not null default 12737,
    level_17 integer not null default 14417,
    level_18 integer not null default 16236,
    level_19 integer not null default 18197,
    level_20 integer not null default 20306,
    level_21 integer not null default 22566,
    level_22 integer not null default 24981,
    level_23 integer not null default 27555,
    level_24 integer not null default 30291,
    level_25 integer not null default 33195,
    level_26 integer not null default 36270,
    level_27 integer not null default 39520,
    level_28 integer not null default 42949,
    level_29 integer not null default 46560,
    level_30 integer not null default 50359,
    level_31 integer not null default 54349,
    level_32 integer not null default 58534,
    level_33 integer not null default 62918,
    level_34 integer not null default 67504,
    level_35 integer not null default 72298,
    level_36 integer not null default 77303,
    level_37 integer not null default 82523,
    level_38 integer not null default 87962,
    level_39 integer not null default 93623,
    level_40 integer not null default 99512,
    level_41 integer not null default 105632,
    level_42 integer not null default 111987,
    level_43 integer not null default 118581,
    level_44 integer not null default 125417,
    level_45 integer not null default 132501,
    level_46 integer not null default 139836,
    level_47 integer not null default 147426,
    level_48 integer not null default 155275,
    level_49 integer not null default 163386,
    level_50 integer not null default 171765,
    level_51 integer not null default 178685
);
------------------------
-- Views
------------------------
